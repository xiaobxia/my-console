...
class IndexList extends PureComponent {
  ...
  ifSellBaijiu = (record, oneDayRecord, twoDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifBuyBaijiu = (record, oneDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifSellNengyuan = (record, oneDayRecord, twoDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifBuyNengyuan = (record, oneDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifSellXinxi = (record, oneDayRecord, twoDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifBuyXinxi = (record, oneDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifSellZhengquan = (record, oneDayRecord, twoDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifBuyZhengquan = (record, oneDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifSellXiaofei = (record, oneDayRecord, twoDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifBuyXiaofei = (record, oneDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifSellBaoxian = (record, oneDayRecord, twoDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
  ...
  ifBuyBaoxian = (record, oneDayRecord) => {
    const ifUpOpen = this.ifUpOpen(record);
    const ifUpClose = this.ifUpClose(record);
    const ifSessionDown = this.ifSessionDown(record);
    const ifSessionUpClose = this.ifSessionUpClose(record);
